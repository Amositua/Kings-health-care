  ...
  return (
    <div ref={topRef} className="bg-lightBlue">
      <div class="container mx-auto px-5 pt-3 ">
       ...
       <p className="pl-5"> Our Site is [owned and] operated by Kings Health Practitioners Limited, a limited company [registered in England under company number 13769758]. [Registered address: 3, Nicon Crescent, Independence Layout, Enugu, Nigeria.
            <br></br>
            <br></br>
        Cumber land house, 24-28 Baxter Avenue, South end- on- sea. England.Email address: 
        <br></br>
...
<br></br>
        ...
        <br></br>
        <p className="pl-5">
        Subject to the following, We do not collect any personal data from you. We do not place cookies on your computer or device, nor do We use any other means of data collection.  3 © PLUS Rrecruitment Limited Website Privacy Policy – Basic (Limited Data) Our Site collects certain information automatically, including your IP address, the type of browser you are using, and certain other non-personal data about your computer or device such as your operating system type or version, and display resolution.
        ...
        10.)   
        How Do I Contact You? To contact us about anything to do with your personal data and 
        <p className="pl-6">
        data protection, including to make a subject access request, please use the following details [(for the attention Kings Health Practitioners Limited)]:
        <br></br>
        <br></br>
        Email address: 
        <br></br>
        ...
        © Kings Health Practitioners Limited Website Privacy Policy – Basic (Limited Data)
        </p>
        </p>
      </div>
    </div>
